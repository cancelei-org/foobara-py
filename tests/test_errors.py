...
class TestErrorCollection:
    def test_add_error(self):
        ...
        error = DataError.data_error("required", ["name"], "Required")
    ...
    def test_add_multiple_errors(self):
        collection = ErrorCollection()
        collection.add_errors(
            DataError.data_error("required", ["name"], "Name required"),
            DataError.data_error("invalid", ["email"], "Invalid email")
        )
    ...
    def test_is_empty(self):
        ...
        collection.add_error(DataError.data_error("test", [], "test"))
    ...
    def test_at_path(self):
        ...
        collection.add_errors(
            DataError.data_error("required", ["name"], "Name required"),
            DataError.data_error("invalid", ["email"], "Invalid email"),
            DataError.data_error("too_short", ["email"], "Email too short")
        )
    ...
    def test_with_symbol(self):
        ...
        collection.add_errors(
            DataError.data_error("required", ["name"], "Name required"),
            DataError.data_error("required", ["email"], "Email required")
        )
    ...
    def test_by_category(self):
        collection = ErrorCollection()
        collection.add_errors(
            DataError.data_error("test", [], "Data error"),
            DataError.runtime_error("test", "Runtime error")
        )
    ...
    def test_first(self):
        ...
        collection.add_error(DataError.data_error("first", [], "First"))
        assert collection.first().symbol == "first"

    def test_messages(self):
        collection = ErrorCollection()
        collection.add_errors(
            DataError.data_error("e1", [], "Error 1"),
            DataError.data_error("e2", [], "Error 2")
        )
    ...
    def test_to_dict(self):
        collection = ErrorCollection()
        collection.add_error(DataError.data_error("required", ["name"], "Required"))
    ...
    def test_merge(self):
        c1 = ErrorCollection()
        c2 = ErrorCollection()
        c1.add_error(DataError.data_error("e1", [], "Error 1"))
        c2.add_error(DataError.data_error("e2", [], "Error 2"))
        c1.merge(c2)
        assert c1.count() == 2
